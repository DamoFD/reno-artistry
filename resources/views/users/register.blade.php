<x-layout>
    ...
    <p class="account-text font-size-sm color-secondary font-roboto-regular">Already have an account? <a class="color-primary" href="/reno-artistry/public/login">Login</a></p>
    </div>
    </section>
    </x-layout>